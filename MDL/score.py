...
print "M_0:\t" + '%.0f' % l_total_0 + "\t" + '%.0f' % l_model_0 + "\t" + '%.0f' %  l_error_0 + "\t" + str(E_0.numModellingErrors) + '/' + str(E_0.numCellsCovered) + '\t' + str(E_0.numUnmodelledErrors)  + '/' + str(((E_0.numNodes * E_0.numNodes)-E_0.numNodes)/2 - E_0.numCellsCovered) + '\t' + str(E_0.numCellsExcluded);
...
if len(sys.argv) > 2 and sys.argv[2][0] != '-' :
    ...
    print "M_x:\t" + '%.0f' % l_total_x + "\t" + '%.0f' % l_model_x + "\t" + '%.0f' % l_error_x + "\t" + str(E_x.numModellingErrors) + '/' + str(E_x.numCellsCovered-E_x.numCellsExcluded) + '\t' + str(E_x.numUnmodelledErrors)  + '/' + str(((E_x.numNodes * E_x.numNodes)-E_x.numNodes)/2 - E_x.numCellsCovered) + '\t\t' + str(E_x.numCellsExcluded);
    #return l_total_x;
